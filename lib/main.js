  ...
  this.Hollerith = (function() {
    class Hollerith {
      ...
      constructor(cfg) {
        ...
        this._only_zeroes_after = this._only_zeroes_after.bind(this);
        //---------------------------------------------------------------------------------------------------------
      ...
      _encode_u32(vnr) {
        ...
        for (idx = i = 0, ref1 = this.cfg.vnr_width; (0 <= ref1 ? i < ref1 : i > ref1); idx = 0 <= ref1 ? ++i : --i) {
          R.writeUInt32BE(((ref2 = vnr[idx]) != null ? ref2 : 0) + C.u32_sign_delta, (offset += C.u32_width));
        }
        return R;
      }
      ...
      _only_zeroes_after(list, first_idx) {
        var i, idx, ref, ref1;
        for (idx = i = ref = first_idx, ref1 = list.length; (ref <= ref1 ? i < ref1 : i > ref1); idx = ref <= ref1 ? ++i : --i) {
          if (list[idx] !== 0) {
            return false;
          }
        }
      ...
      cmp(a, b) {
        ...
        if (a_length < b_length) {
          if (this._only_zeroes_after(b, min_idx + 1)) {
            return 0;
          }
        ...
        if (this._only_zeroes_after(a, min_idx + 1)) {
          return 0;
        }
